...
const Billing = () => (
    <section id='product' className={layout.sectionReverse}>
        <div className={layout.sectionImgReverse}>
            ...
            <div className="absolute z-[3] -left-1/ top-0 w-[50%] h-[50%] rounded-full white__gradiet" />
            <div className="absolute z-[0] -left-1/ bottom-0 w-[50%] h-[50%] rounded-full pink__gradiet" />
        </div>
